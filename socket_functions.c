...
int isInCache(struct requestCache *cachePtr, const char* requestedObject, unsigned char** copyDestination) // #isInCache
{
...
int saveCacheToFile(struct requestCache *cachePtr) // #saveCacheToFile
{
...
int readCacheFromFile(struct requestCache *cachePtr) // #readCacheFromFile
{
	FILE* cacheMetadata = NULL;
